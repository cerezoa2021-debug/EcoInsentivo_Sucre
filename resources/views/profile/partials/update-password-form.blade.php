<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-5">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Contraseña Actual')" class="font-medium text-sm" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('Nueva Contraseña')" class="font-medium text-sm" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirmar Contraseña')" class="font-medium text-sm" />
